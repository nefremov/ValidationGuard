...
- **Script**: `python3 config/kits/sdlc/scripts/pr.py`
- **Config**: `{cypilot_path}/config/pr-review.toml`
- **Code review template**: `config/kits/sdlc/artifacts/PR-CODE-REVIEW-TEMPLATE/template.md`
- **Status report template**: `config/kits/sdlc/artifacts/PR-STATUS-REPORT-TEMPLATE/template.md`
- **Checklists**: Referenced per-prompt in `pr-review.toml`
- **Prompts**: `config/kits/sdlc/scripts/prompts/pr/`
- **PR data**: `.prs/{ID}/`
...
// turbo
Run: `python3 config/kits/sdlc/scripts/pr.py list`
...
// turbo
Run: `python3 config/kits/sdlc/scripts/pr.py fetch <ARG>`
...
Read the template at `config/kits/sdlc/artifacts/PR-CODE-REVIEW-TEMPLATE/template.md` and
